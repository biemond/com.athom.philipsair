...
class deviceCoap2 extends AirDevice {
  ...
  async onInit() {
    ...
    this.registerCapabilityListener('target_humidity', async (value) => {
      let model = this.getCapabilityValue('product')
      const newCoapDevices2 = ['AC3737/10','AC3421/13','HU1509/00','HU1510/03','HU5710/00']  
      if (newCoapDevices2.includes(model)) {
    ...
    this.registerCapabilityListener('display_mode_ph', async (value) => {
      let model = this.getCapabilityValue('product')
      const newCoapDevices2 =  ['AC3737/10','AMF765/10','AC3421/13','AC4236/14','AMF870/15','HU1510/03','HU5710/00']  
      if (newCoapDevices2.includes(model)) {
    ...
    this.registerCapabilityListener('onoff', async (value) => {
      let values;
      let model = this.getCapabilityValue('product')
      const newCoapDevices2 = ['AC3737/10','AC3421/13','AC4236/14','AMF870/15','HU1509/00','HU1510/03','HU5710/00']  
      if (newCoapDevices2.includes(model)) {
        if (value == true) {
          values = 1;
        } else {
    ...
    this.registerCapabilityListener('child_lock', async (value) => {
      let model = this.getCapabilityValue('product')      
      const newCoapDevices2 = ['AC3737/10','AMF765/10','AC3421/13','AC4236/14','AMF870/15','HU1509/00','HU1510/03','HU5710/00']        
      if (newCoapDevices2.includes(model)) {
        let values;
        if (value == true) {
          values = 1;
